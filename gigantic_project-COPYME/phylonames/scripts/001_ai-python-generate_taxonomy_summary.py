#!/usr/bin/env python3
# AI: Claude Code | Opus 4.5 | 2026 February 12 | Purpose: Generate static taxonomy summary from phylonames mapping
# Human: Eric Edsinger
...
Output:
    ...
    - HTML summary file (optional, for web viewing)

Usage:
    python 001_ai-python-generate_taxonomy_summary.py --input mapping.tsv --output summary.md
    python 001_ai-python-generate_taxonomy_summary.py --input mapping.tsv --output summary.html --format html
"""
...
def generate_markdown_summary( analysis, input_filename ):
    ...
    # Header
    lines.append( f"# GIGANTIC Phylonames Summary" )
    lines.append( f"" )
...
def generate_html_summary( analysis, input_filename ):
...
<head>
    ...
    <title>GIGANTIC Phylonames Summary</title>
    <style>
        body {{
...
<body>
    <h1>GIGANTIC Phylonames Summary</h1>
...
Examples:
    ...
    python 001_ai-python-generate_taxonomy_summary.py --input species67-map.tsv --output summary.md

    # Generate HTML summary
    python 001_ai-python-generate_taxonomy_summary.py --input species67-map.tsv --output summary.html --format html
...
"""
    ...
    if args.format == 'html':
        content = generate_html_summary( analysis, input_path.name )
    else:
        content = generate_markdown_summary( analysis, input_path.name )
