# User Research - orthogroups

**Your personal workspace for orthogroups-related work.**
...
```
subprojects/orthogroups/user_research/
├── notes/
├── exploratory_scripts/
├── literature/
└── [your organization]
...
```
research_notebook/research_user/subproject-orthogroups/
├── notes/
├── exploratory_scripts/
├── literature/
└── [your organization]
...
- Move `user_research/` contents to `research_notebook/research_user/subproject-orthogroups/`
