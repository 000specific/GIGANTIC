...
**For AI Assistants**: This guide covers workflow execution. For STEP_2 concepts, see `../../AI_GUIDE-phylogenetic_analysis.md`. For trees_gene_groups overview, see `../../../AI_GUIDE-trees_gene_groups.md`. For GIGANTIC overview, see `../../../../../AI_GUIDE-project.md`.

**Location**: `trees_gene_groups/STEP_2-phylogenetic_analysis/workflow-COPYME-phylogenetic_analysis/`
...
│
├── INPUT_user/                        # (empty - reads from subproject output_to_input/gene_groups-hugo_hgnc/STEP_1-homolog_discovery/gene_group-<gene_family>)
│
├── OUTPUT_pipeline/
│   ├── 1-output/       # Staged AGS
...
|---------|---------|------|
| prepare_alignment_input | 001 | Copies AGS from output_to_input/gene_groups-hugo_hgnc/STEP_1-homolog_discovery/gene_group-<gene_family> |
...
| *(symlinks by RUN-workflow.sh)* | - | Export tree newicks and alignments to output_to_input/gene_groups-hugo_hgnc/STEP_2-phylogenetic_analysis/gene_group-<gene_family> |
...
Only enabled methods run. All enabled tree newick files are exported to `output_to_input/gene_groups-hugo_hgnc/STEP_2-phylogenetic_analysis/gene_group-<gene_family>/` for downstream consumption.
