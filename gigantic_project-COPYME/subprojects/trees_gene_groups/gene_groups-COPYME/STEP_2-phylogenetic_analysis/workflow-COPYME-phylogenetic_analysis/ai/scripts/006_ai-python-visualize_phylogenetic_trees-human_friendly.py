#!/usr/bin/env python3
# GIGANTIC STEP_2 - Script 006: Visualize Trees (Human-Friendly)
...
Usage:
    python3 006_ai-python-visualize_phylogenetic_trees-human_friendly.py [options]
...
Output Files:
    - 7-AGS-speciesN_T1-species37-innexin_pannexin-fasttree-human_friendly.svg
    - 7-AGS-speciesN_T1-species37-innexin_pannexin-fasttree-human_friendly.pdf
    - 7-AGS-speciesN_T1-species37-innexin_pannexin-iqtree-human_friendly.svg
    - 7-AGS-speciesN_T1-species37-innexin_pannexin-iqtree-human_friendly.pdf
