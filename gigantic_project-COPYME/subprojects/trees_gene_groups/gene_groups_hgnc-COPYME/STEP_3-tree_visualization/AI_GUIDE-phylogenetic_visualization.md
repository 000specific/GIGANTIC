...
**For AI Assistants**: Read `../../../AI_GUIDE-project.md` first for GIGANTIC overview. Then `../../AI_GUIDE-trees_gene_groups.md` for subproject concepts. This guide covers STEP_3.
