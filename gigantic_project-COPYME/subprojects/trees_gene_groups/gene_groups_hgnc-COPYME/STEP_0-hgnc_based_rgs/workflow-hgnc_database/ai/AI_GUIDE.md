...
sibling `workflow-hgnc_user_list`).
...
# 2. Configure
cd gene_groups-hgnc_all/STEP_0-hgnc_based_rgs/workflow-hgnc_database/
...
## Differences From `workflow-hgnc_user_list`

| | `workflow-hgnc_database` | `workflow-hgnc_user_list` |
|---|---|---|
