...
```
output_to_input/
├── STEP_1-rgs_preparation/rgs_fastas/<gene_group>/     # Validated RGS
├── STEP_2-homolog_discovery/ags_fastas/<gene_group>/   # Homolog sequences (AGS)
└── STEP_3-phylogenetic_analysis/trees/<gene_group>/    # Trees and visualizations
```
