...
SYMLINK_DIR="../../../../output_to_input/${SOURCE_DIR}/STEP_2-phylogenetic_analysis/${GENE_GROUP_DIR}"
mkdir -p "${SYMLINK_DIR}"
...
echo "  output_to_input/${SOURCE_DIR}/STEP_2-phylogenetic_analysis/${GENE_GROUP_DIR}/ -> symlinks created"
