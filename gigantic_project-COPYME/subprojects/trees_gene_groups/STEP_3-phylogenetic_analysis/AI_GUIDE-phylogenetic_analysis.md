# AI Guide: STEP_3-phylogenetic_analysis (trees_gene_groups)

**For AI Assistants**: This guide covers STEP_3 of the trees_gene_groups subproject. For subproject overview, see `../AI_GUIDE-trees_gene_groups.md`. For GIGANTIC overview, see `../../../AI_GUIDE-project.md`.

**Location**: `gigantic_project-COPYME/subprojects/trees_gene_groups/STEP_3-phylogenetic_analysis/`
...
| **IQ-TREE** | 005_c | OFF | Hours-days | Publication-quality, automatic model selection |
| **VeryFastTree** | 005_b | OFF | Very fast | Large datasets (>10,000 sequences) |
...
├── 5_b-output/     # VeryFastTree tree (if enabled)
├── 5_c-output/     # IQ-TREE tree (if enabled)
...
└── workflow-COPYME-phylogenetic_analysis/
    ...
    └── ai/
        ...
        └── scripts/
            ...
            ├── 005_b_ai-bash-run_superfasttree.sh
...
|------|---------|-------------|
| `workflow-*/START_HERE-user_config.yaml` | Gene group, tree methods, alignment settings | **YES** |
