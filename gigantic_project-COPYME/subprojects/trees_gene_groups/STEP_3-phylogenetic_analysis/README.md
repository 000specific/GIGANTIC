...
- STEP_2 must be complete for the same gene group (AGS file in ../output_to_input/STEP_2-homolog_discovery/)
...
- `../output_to_input/STEP_3-phylogenetic_analysis/trees/<gene_group>/`
