#!/bin/bash
# AI: Claude Code | Opus 4.6 | 2026 March 10 | Purpose: Run STEP_1 RGS validation Nextflow pipeline
# Human: Eric Edsinger

# =============================================================================
# RUN-workflow.sh
# =============================================================================
# Runs the STEP_1 RGS validation Nextflow pipeline.
...
if [ "${EXECUTION_MODE}" == "slurm" ] && [ -z "${SLURM_JOB_ID}" ]; then
    ...
    SBATCH_ARGS="--job-name=validate_rgs"
    ...
    SBATCH_ARGS="${SBATCH_ARGS} --output=slurm_logs/validate_rgs-%j.log"
...
echo "========================================================================"
echo "Starting STEP_1 RGS Validation Pipeline"
echo "========================================================================"
