...
// AI: Claude Code | Opus 4.6 | 2026 February 27 | Purpose: STEP_2 phylogenetic analysis workflow with configurable tree methods
// Human: Eric Edsinger
...
params.step2_ags_fastas_dir = config.input?.step2_ags_fastas_dir ?: '../../../output_to_input/STEP_1-homolog_discovery/ags_fastas'
...
process prepare_alignment_input {
    ...
    # Find AGS file from subproject output_to_input/STEP_1-homolog_discovery
    ...
    if [ -z "\${AGS_FILE}" ] || [ ! -f "\${AGS_FILE}" ]; then
        ...
        echo "Ensure STEP_2 has completed and output_to_input/STEP_1-homolog_discovery/ags_fastas/${gene_family}/ contains results."
        exit 1
    fi
