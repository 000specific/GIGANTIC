...
RUN-workflow.sh
  ...
  ├── creates/heals conda env (aiG-trees_gene_families-visualization)
...
- Small gene families (< 100 tips): seconds
...
STEP_2 hasn't produced trees for this gene family. Run STEP_2 first.
...
```bash
conda env remove -n aiG-trees_gene_families-visualization -y
...
```bash
head -c 500 ../../../../output_to_input/<gene_family>/STEP_2-phylogenetic_analysis/*.fasttree
```
...
3. Check symlinks: `ls -l ../../../../output_to_input/<gene_family>/STEP_3-tree_visualization/`
