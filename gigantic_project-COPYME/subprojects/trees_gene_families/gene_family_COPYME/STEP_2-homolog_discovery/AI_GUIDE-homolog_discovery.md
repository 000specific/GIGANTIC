...
| Level | Path |
|-------|------|
| Subproject-root | `../output_to_input/STEP_2-homolog_discovery/ags_fastas/<gene_family>/16_ai-ags-*.aa` |
...
# Note: output goes to ../output_to_input/STEP_2-homolog_discovery/ags_fastas/
    ├── README.md
    ├── RUN-workflow.sh
    ├── RUN-workflow.sbatch
