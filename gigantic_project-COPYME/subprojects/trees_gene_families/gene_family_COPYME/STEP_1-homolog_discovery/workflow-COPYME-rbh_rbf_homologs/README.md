...
STEP_1 workflow template for discovering homologs via Reciprocal Best Hit (RBH) / Reciprocal Best Family (RBF) BLAST methodology for **one gene family per workflow copy**.

**Part of**: STEP_1-homolog_discovery (see `../README.md`)
...
- **genomesDB subproject** complete (provides BLAST databases)
...
After this workflow completes, copy the STEP_2 template and run phylogenetic analysis:
```bash
