# User Research - annotations_X_ocl

**Your personal workspace for annotations_X_ocl-related work.**
...
```
subprojects/annotations_X_ocl/user_research/
├── notes/
├── exploratory_scripts/
├── literature/
└── [your organization]
...
```
research_notebook/research_user/subproject-annotations_X_ocl/
├── notes/
├── exploratory_scripts/
├── literature/
└── [your organization]
...
- Move `user_research/` contents to `research_notebook/research_user/subproject-annotations_X_ocl/`
