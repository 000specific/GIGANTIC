...
Annotation Database : ${config.annotation_database}
Annogroup Subtypes  : ${config.annogroup_subtypes}
...
workflow.onComplete {
    log.info """
    ==============================================================================
    GIGANTIC ANNOTATIONS OCL PIPELINE - COMPLETED
    ==============================================================================
    Status      : ${workflow.success ? 'SUCCESS' : 'FAILED'}
    Duration    : ${workflow.duration}
    Run Label   : ${config.run_label}
    Database    : ${config.annotation_database}
    Results     : ${output_dir}
...
workflow.onError {
    log.error """
    ==============================================================================
    GIGANTIC ANNOTATIONS OCL PIPELINE - ERROR
    ==============================================================================
