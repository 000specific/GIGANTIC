# User Research - trees_gene_families

**Your personal workspace for trees_gene_families-related work.**
...
```
subprojects/trees_gene_families/user_research/
├── notes/
├── exploratory_scripts/
├── literature/
└── [your organization]
...
- Move `user_research/` contents to `research_notebook/research_user/subproject-trees_gene_families/`
