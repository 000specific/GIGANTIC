...
Output:
    OUTPUT_pipeline/9-output/9_ai-per_species_summary.tsv
        Per-species orthogroup statistics

Usage:
    python3 009_ai-python-qc_analysis_per_species.py \\
...
def setup_logging( output_directory: Path ) -> logging.Logger:
    ...
    # File handler
    log_file = output_directory / '9_ai-log-qc_analysis_per_species.log'
...
def main():
    ...
    parser.add_argument(
        '--output-dir',
        type = str,
        default = 'OUTPUT_pipeline/9-output',
        help = 'Output directory (default: OUTPUT_pipeline/9-output)'
    )
    ...
    summary_file = output_directory / '9_ai-per_species_summary.tsv'
