#!/bin/bash
# AI: Claude Code | Opus 4.6 | 2026 February 28 | Purpose: Clean NextFlow artifacts and record sessions for OrthoHMM project
# Human: Eric Edsinger

set -e

echo "Cleaning OrthoHMM project..."
