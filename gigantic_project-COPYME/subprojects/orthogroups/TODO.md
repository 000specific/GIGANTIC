...
- [x] Consistent naming: RUN-workflow.sh, RUN-workflow.sh, START_HERE-user_config.yaml
...
- [x] Standardized all documentation to use `RUN-workflow.sh` / `RUN-workflow.sh` naming across all 15 .md files
...
- [ ] **Verify conda environment**: Install `aiG-orthogroups-<tool>` and confirm all tools are available
