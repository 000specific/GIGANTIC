...
Output:
    OUTPUT_pipeline/8-output/8_ai-per_species_summary.tsv
        Per-species orthogroup statistics

Usage:
    python3 008_ai-python-qc_analysis_per_species.py \\
...
def setup_logging( output_directory: Path ) -> logging.Logger:
    ...
    # File handler
    log_file = output_directory / '8_ai-log-qc_analysis_per_species.log'
...
def main():
    ...
    summary_file = output_directory / '8_ai-per_species_summary.tsv'
