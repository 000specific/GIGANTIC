...
Input:
    ...
    --orthohmm-dir: Path to OrthoHMM output directory from script 005

Output:
    OUTPUT_pipeline/6-output/6_ai-orthogroups_gigantic_ids.tsv
...
Usage:
    python3 006_ai-python-restore_gigantic_identifiers.py \\
        ...
        --orthohmm-dir OUTPUT_pipeline/5-output
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type = str,
        required = True,
        help = 'Path to OrthoHMM output directory from script 005'
    )
    ...
    orthogroups_output_path = output_directory / '6_ai-orthogroups_gigantic_ids.tsv'
    orthogroup_count = 0
    ...
    if not gene_count_input.exists():
        ...
        logger.error( "Check script 005 log for OrthoHMM errors." )
        sys.exit( 1 )
