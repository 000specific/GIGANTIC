...
#   1. BLOCK_orthofinder/output_to_input/  (canonical, for downstream subprojects)
...
ln -sf "../workflow-COPYME-run_orthofinder/OUTPUT_pipeline/4-output/4_ai-orthogroups_gigantic_ids.tsv" \
    "${BLOCK_SHARED_DIR}/orthogroups_gigantic_ids.tsv"
ln -sf "../workflow-COPYME-run_orthofinder/OUTPUT_pipeline/4-output/4_ai-gene_count_gigantic_ids.tsv" \
    "${BLOCK_SHARED_DIR}/gene_count_gigantic_ids.tsv"
ln -sf "../workflow-COPYME-run_orthofinder/OUTPUT_pipeline/5-output/5_ai-summary_statistics.tsv" \
    "${BLOCK_SHARED_DIR}/summary_statistics.tsv"
ln -sf "../workflow-COPYME-run_orthofinder/OUTPUT_pipeline/6-output/6_ai-per_species_summary.tsv" \
