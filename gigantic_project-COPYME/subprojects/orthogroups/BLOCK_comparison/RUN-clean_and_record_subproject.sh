#!/bin/bash
# AI: Claude Code | Opus 4.6 | 2026 February 28 | Purpose: Clean NextFlow artifacts and record sessions for Comparison project
# Human: Eric Edsinger

set -e

echo "Cleaning Comparison project..."
...
echo "Comparison project cleaned."
