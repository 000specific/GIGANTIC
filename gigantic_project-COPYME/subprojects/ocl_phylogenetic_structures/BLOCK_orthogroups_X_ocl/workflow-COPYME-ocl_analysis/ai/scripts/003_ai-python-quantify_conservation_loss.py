...
def main():
    ...
    total_conservation = sum( p[ 'conservation_events' ] for p in orthogroup_patterns )
    total_loss = sum( p[ 'loss_origin_events' ] for p in orthogroup_patterns )
    total_continued_absence = sum( p[ 'continued_absence_events' ] for p in orthogroup_patterns )
    total_scored_blocks = sum( p[ 'total_scored_blocks' ] for p in orthogroup_patterns )
    emit_run_summary_fragment(
        ...
        stats = {
            ...
            'orthogroups_analyzed': len( orthogroup_patterns ),
            'total_scored_blocks': total_scored_blocks,
