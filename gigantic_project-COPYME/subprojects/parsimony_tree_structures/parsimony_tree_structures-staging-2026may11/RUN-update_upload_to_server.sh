#!/bin/bash
# AI: Claude Code | Opus 4.7 | 2026 May 11 | Purpose: Thin wrapper around shared update_upload_to_server.py
# Human: Eric Edsinger

################################################################################
# GIGANTIC parsimony_tree_structures - Upload to Server Builder
################################################################################
#
# PURPOSE:
