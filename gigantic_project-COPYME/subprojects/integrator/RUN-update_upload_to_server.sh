#!/bin/bash
# AI: Claude Code | Opus 4.8 (1M context) | 2026 June 09 | Purpose: Thin wrapper around shared update_upload_to_server.py
# Human: Eric Edsinger

################################################################################
# GIGANTIC integrator - Upload to Server Builder
################################################################################
#
# PURPOSE:
