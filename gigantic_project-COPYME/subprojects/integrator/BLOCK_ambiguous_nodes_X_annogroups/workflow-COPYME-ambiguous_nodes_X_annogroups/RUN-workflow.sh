...
**Run label**: \`${RUN_LABEL}\`
**Species set**: \`${SPECIES_SET}\`
**Downstream symlinks**: ${SYMLINK_COUNT} (in ../../output_to_input/BLOCK_ambiguous_nodes_X_annogroups/${RUN_LABEL}/)
