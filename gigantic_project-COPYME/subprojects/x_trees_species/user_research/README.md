# User Research - trees_species

**Your personal workspace for trees_species-related work.**
...
```
subprojects/trees_species/user_research/
├── notes/
├── exploratory_scripts/
├── literature/
└── [your organization]
...
```
research_notebook/research_user/subproject-trees_species/
├── notes/
├── exploratory_scripts/
├── literature/
└── [your organization]
...
- Move `user_research/` contents to `research_notebook/research_user/subproject-trees_species/`
