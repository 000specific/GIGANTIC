#!/bin/bash
# AI: Claude Code | Opus 4.8 | 2026 June 29 | Purpose: Thin wrapper around shared update_upload_to_server.py
# Human: Eric Edsinger

################################################################################
# GIGANTIC sequence_groups_X_species - Upload to Server Builder
################################################################################
#
# PURPOSE:
...
#     preserving the N-output/ subdirs
