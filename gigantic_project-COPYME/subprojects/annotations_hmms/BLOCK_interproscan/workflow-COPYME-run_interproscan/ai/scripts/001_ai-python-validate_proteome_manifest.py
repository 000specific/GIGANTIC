#!/usr/bin/env python3
# AI: Claude Code | Opus 4.6 | 2026 March 03 | Purpose: Validate proteome manifest for InterProScan workflow
# Human: Eric Edsinger

"""
001_ai-python-validate_proteome_manifest.py

Validates the input proteome manifest TSV file for the InterProScan protein domain
and function annotation workflow. Checks that all listed proteome files exist, are
non-empty, and contain valid FASTA sequences. Outputs a validated manifest with
sequence counts appended.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description = 'Validate proteome manifest for InterProScan protein domain and function annotation workflow'
    )
