#!/bin/bash
# AI: Claude Code | Opus 4.6 | 2026 March 03 | Purpose: Clean NextFlow artifacts for InterProScan project
# Human: Eric Edsinger

set -e

echo "Cleaning InterProScan project..."
...
echo "InterProScan project cleaned."
