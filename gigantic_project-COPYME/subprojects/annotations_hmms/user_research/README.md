# User Research - annotations_hmms

**Your personal workspace for annotations_hmms-related work.**
...
```
subprojects/annotations_hmms/user_research/
├── notes/
├── exploratory_scripts/
├── literature/
└── [your organization]
...
```
research_notebook/research_user/subproject-annotations_hmms/
├── notes/
├── exploratory_scripts/
├── literature/
└── [your organization]
...
- Move `user_research/` contents to `research_notebook/research_user/subproject-annotations_hmms/`
