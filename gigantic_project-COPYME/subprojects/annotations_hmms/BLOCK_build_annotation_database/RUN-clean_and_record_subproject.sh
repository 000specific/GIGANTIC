#!/bin/bash
# AI: Claude Code | Opus 4.6 | 2026 March 03 | Purpose: Clean NextFlow artifacts for Annotation Database Builder project
# Human: Eric Edsinger

set -e

echo "Cleaning Annotation Database Builder project..."
...
echo "Annotation Database Builder project cleaned."
