...
if ! command -v nextflow &> /dev/null; then
    ...
    if ! command -v nextflow &> /dev/null; then
        ...
        echo ""
        echo "NextFlow is required but was not found in the conda environment"
        echo "'ai_gigantic_annotations_hmms' or as a system module."
        echo ""
        echo "To fix, either:"
        echo "  1. Install nextflow in the conda environment"
        echo "  2. Ensure 'module load nextflow' works on your system"
        echo ""
        exit 1
    fi
