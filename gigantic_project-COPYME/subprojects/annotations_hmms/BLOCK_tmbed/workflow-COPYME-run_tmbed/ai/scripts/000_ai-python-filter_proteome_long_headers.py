#!/usr/bin/env python3
# AI: Claude Code | Opus 4.7 | 2026 May 22 | Purpose: Filter proteome FASTAs - drop records whose header line exceeds the filesystem-safe length so per-protein output filenames (SignalP6 plot files, TMBed work dirs) stay under 255 bytes
# Human: Eric Edsinger
