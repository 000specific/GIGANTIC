...
- Parent BLOCK guide: [`../../AI_GUIDE.md`](../../AI_GUIDE.md) — MetaPredict concepts
...
- Outputs to: `../../../output_to_input/BLOCK_metapredict/`
- 4 scripts in `scripts/` (final = `write_run_log` per §45)
...
| MetaPredict concepts | `../../AI_GUIDE.md` |
...
- `START_HERE-user_config.yaml` - Set disorder threshold, and species list
