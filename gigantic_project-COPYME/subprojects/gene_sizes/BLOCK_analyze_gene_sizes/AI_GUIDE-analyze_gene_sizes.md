...
| Running Tier 1 (`all_inclusive`) | `workflow-COPYME-analyze_gene_sizes-all_inclusive/ai/AI_GUIDE-analyze_gene_sizes_workflow.md` |
| Running Tier 2 (`gene_vs_protein`) | `workflow-COPYME-analyze_gene_sizes-gene_vs_protein/ai/AI_GUIDE-analyze_gene_sizes_workflow.md` |
