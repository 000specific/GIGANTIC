...
- Sibling tier: `../workflow-COPYME-analyze_gene_sizes-all_inclusive/` — Tier 1 (`all_inclusive`) is the subset with richer (UTR-aware) metrics
...
metrics that are universally derivable. See `../AI_GUIDE.md`
and `../../AI_GUIDE.md` for the full dual-tier architecture.
