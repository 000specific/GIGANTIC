#!/bin/bash
# AI: Claude Code | Opus 4.8 (1M context) | 2026 June 28 | Purpose: Thin wrapper around shared update_upload_to_server.py
# Human: Eric Edsinger

################################################################################
# GIGANTIC one_direction_homologs - Upload to Server Builder
################################################################################
#
# PURPOSE:
