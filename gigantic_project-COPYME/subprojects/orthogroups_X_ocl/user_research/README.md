# User Research - orthogroups_X_ocl

**Your personal workspace for orthogroups_X_ocl-related work.**
...
```
subprojects/orthogroups_X_ocl/user_research/
├── notes/
├── exploratory_scripts/
├── literature/
└── [your organization]
...
```
research_notebook/research_user/subproject-orthogroups_X_ocl/
├── notes/
├── exploratory_scripts/
├── literature/
└── [your organization]
...
- Move `user_research/` contents to `research_notebook/research_user/subproject-orthogroups_X_ocl/`
