#!/bin/bash
# AI: Claude Code | Opus 4.7 (1M context) | 2026 May 26 | Purpose: Thin wrapper around shared update_upload_to_server.py — publishes phylonames outputs to the project's data server
# Human: Eric Edsinger

################################################################################
# GIGANTIC phylonames — Upload to Server Builder
################################################################################
#
