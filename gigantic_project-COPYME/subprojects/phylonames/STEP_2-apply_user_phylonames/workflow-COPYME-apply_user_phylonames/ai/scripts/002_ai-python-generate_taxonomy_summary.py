...
Usage:
    python 002_ai-python-generate_taxonomy_summary.py --input mapping.tsv --output-dir 2-output/
"""
...
Examples:
    ...
    python 002_ai-python-generate_taxonomy_summary.py --input mapping.tsv --output-dir 2-output/ --project-name speciesN
"""
    )
