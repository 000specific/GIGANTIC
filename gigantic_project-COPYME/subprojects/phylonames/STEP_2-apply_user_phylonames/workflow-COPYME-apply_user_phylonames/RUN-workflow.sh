...
if [ ! -f "INPUT_user/user_phylonames.tsv" ]; then
    ...
    echo ""
    echo "Format: TSV with 3 columns: genus_species<TAB>custom_phyloname<TAB>unofficial_action"
    echo "  unofficial_action: ADD_UNOFFICIAL (standard) or SUPPRESS_UNOFFICIAL"
    echo "Example:"
    echo "  Monosiga_brevicollis_MX1	Holozoa_Choanozoa_Choanoflagellata_Craspedida_Salpingoecidae_Monosiga_brevicollis_MX1	ADD_UNOFFICIAL"
    echo ""
