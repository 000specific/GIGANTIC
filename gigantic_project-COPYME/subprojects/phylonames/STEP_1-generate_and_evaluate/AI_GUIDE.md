...
**For AI Assistants**: Read `../AI_GUIDE.md` first for subproject overview and phylonames concepts. This guide covers the STEP 1 workflow.
...
| Running the workflow | `workflow-COPYME-generate_phylonames/ai/AI_GUIDE.md` |
