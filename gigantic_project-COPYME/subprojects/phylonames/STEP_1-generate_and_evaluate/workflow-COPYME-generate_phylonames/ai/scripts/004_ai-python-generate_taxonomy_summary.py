...
Usage:
    python 004_ai-python-generate_taxonomy_summary.py --input mapping.tsv --output-dir 4-output/
"""
...
Examples:
    ...
    python 004_ai-python-generate_taxonomy_summary.py --input mapping.tsv --output-dir 4-output/ --project-name speciesN
"""
    )
