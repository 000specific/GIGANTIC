...
Your mapping file appears in `OUTPUT_pipeline/3-output/` and is also symlinked to `../../output_to_input/BLOCK_generate_phylonames/maps/` for downstream subprojects.
