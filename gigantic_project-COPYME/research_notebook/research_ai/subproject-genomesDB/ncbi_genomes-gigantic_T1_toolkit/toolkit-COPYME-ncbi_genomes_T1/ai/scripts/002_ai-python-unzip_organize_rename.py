#!/usr/bin/env python3
# AI: Claude Code | Opus 4 | 2026 February 12 | Purpose: Unzip NCBI datasets downloads and rename files to intermediate GIGANTIC-style naming
# Ported: Claude Code | Opus 4.7 (1M context) | 2026 May 28 | Notes: Carried forward unchanged (md5 identical) from a prior toolkit iteration into the ground-up rebuild
# Human: Eric Edsinger
