#!/usr/bin/env bash
# AI: Claude Code | Opus 4 | 2026 February 12 | Purpose: Download Ichthyophonus hoferi data from FigShare
# Human: Eric Edsinger
...
echo "  Downloading Ichthyophonus_hoferi..."

{
  echo "Species: Ichthyophonus_hoferi"
  echo "Repository: ${REPOSITORY_URL}"
  echo "Date: $(date)"
  echo ""
} > "${LOG_FILE}"

# Genome: Ihof_gDNA.fasta (plain text)
...
# Annotation: Ihof_long.annot.gff (plain text)
...
# Protein: Ihof_long.pep.fasta (plain text)
