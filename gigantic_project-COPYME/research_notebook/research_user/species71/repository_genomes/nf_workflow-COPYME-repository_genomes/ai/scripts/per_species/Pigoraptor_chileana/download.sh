#!/usr/bin/env bash
# AI: Claude Code | Opus 4 | 2026 February 12 | Purpose: Download Pigoraptor chileana from FigShare (article 19895962)
# Human: Eric Edsinger
...
SPECIES="Pigoraptor_chileana"
ZIP_URL="${GENOME_URL:-https://ndownloader.figshare.com/files/35315725}"
