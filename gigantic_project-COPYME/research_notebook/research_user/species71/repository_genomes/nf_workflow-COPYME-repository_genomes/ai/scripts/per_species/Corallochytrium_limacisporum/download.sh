#!/usr/bin/env bash
# AI: Claude Code | Opus 4 | 2026 February 12 | Purpose: Download Corallochytrium limacisporum data from FigShare
# Human: Eric Edsinger
...
echo "  Downloading Corallochytrium_limacisporum..."

{
  echo "Species: Corallochytrium_limacisporum"
  echo "Repository: ${REPOSITORY_URL}"
  echo "Date: $(date)"
  echo ""
} > "${LOG_FILE}"

# Genome: Clim_gDNA.fasta (plain text)
...
# Annotation: Clim_long.annot.gff (plain text)
...
# Protein: Clim_long.pep.fasta (plain text)
