#!/usr/bin/env bash
# AI: Claude Code | Opus 4 | 2026 February 12 | Purpose: Download Lingula anatina data from OIST Marine Genomics
# Human: Eric Edsinger
...
echo "  Downloading Lingula_anatina..."

{
  echo "Species: Lingula_anatina"
  echo "Repository: ${REPOSITORY_URL}"
  echo "Date: $(date)"
  echo ""
} > "${LOG_FILE}"

# Genome: lingula_genome_v1.0_unmasked.fa.gz (gzipped)
...
# Annotation: lingula_genome_v1.0_masked.gff.gz (gzipped)
...
# Protein: lingula_genome_v1.0_prot.fa.gz (gzipped)
