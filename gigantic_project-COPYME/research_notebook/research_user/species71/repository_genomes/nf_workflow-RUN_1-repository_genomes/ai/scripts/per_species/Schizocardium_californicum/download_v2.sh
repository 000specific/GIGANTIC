#!/usr/bin/env bash
# AI: Claude Code | Opus 4 | 2026 February 12 | Purpose: Download Schizocardium californicum data from Zenodo/MATEdb2
# Human: Eric Edsinger

# Zenodo record: https://zenodo.org/records/13148652
# Direct download URLs provided by user
# Genome: https://zenodo.org/records/13148652/files/Schizocardium_californicum.fasta?download=1
# GTF: https://zenodo.org/records/13148652/files/Schizocardium_californicum.gtf?download=1
# Proteome: https://zenodo.org/records/13148652/files/Schizocardium_californicum.faa?download=1
...
SPECIES="Schizocardium_californicum"

DIRECT_GENOME_URL="https://zenodo.org/records/13148652/files/Schizocardium_californicum.fasta?download=1"
DIRECT_GTF_URL="https://zenodo.org/records/13148652/files/Schizocardium_californicum.gtf?download=1"
DIRECT_PROTEIN_URL="https://zenodo.org/records/13148652/files/Schizocardium_californicum.faa?download=1"
