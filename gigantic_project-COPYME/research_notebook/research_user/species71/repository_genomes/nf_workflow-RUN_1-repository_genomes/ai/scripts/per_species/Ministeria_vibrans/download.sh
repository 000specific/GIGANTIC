#!/usr/bin/env bash
# AI: Claude Code | Opus 4 | 2026 February 12 | Purpose: Download Ministeria vibrans from FigShare (article 19895962)
# Human: Eric Edsinger
...
ZIP_URL="${GENOME_URL:-https://ndownloader.figshare.com/files/35315734}"
