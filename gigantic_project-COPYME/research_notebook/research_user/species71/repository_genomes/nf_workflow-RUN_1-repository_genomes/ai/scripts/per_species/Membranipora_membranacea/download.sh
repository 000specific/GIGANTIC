#!/usr/bin/env bash
# AI: Claude Code | Opus 4 | 2026 February 12 | Purpose: Download Membranipora membranacea from NCBI (GCA_947545085.1, Darwin Tree of Life)
# Human: Eric Edsinger

# Dryad doi:10.5061/dryad.76hdr7t3f file IDs unknown. NCBI fallback: GCA_947545085.1
...
NCBI_ACCESSION="GCA_914767715.1"
...

{
  ...
  echo "NCBI accession: ${NCBI_ACCESSION} (Darwin Tree of Life)"
  echo "Date: $( date )"
  echo ""
} > "${LOG_FILE}"
