#!/usr/bin/env bash
# AI: Claude Code | Opus 4 | 2026 February 12 | Purpose: Download Pirum gemmata data from FigShare
# Human: Eric Edsinger
...
echo "  Downloading Pirum_gemmata..."

{
  echo "Species: Pirum_gemmata"
  echo "Repository: ${REPOSITORY_URL}"
  echo "Date: $(date)"
  echo ""
} > "${LOG_FILE}"

# Genome: Pgem_gDNA.fasta (plain text)
...
# Annotation: Pgem_long.annot.gff (plain text)
...
# Protein: Pgem_long.pep.fasta (plain text)
